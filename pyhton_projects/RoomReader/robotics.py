...
Temperature_icon = Button(root, image=temp_icon, borderwidth=BORDER_WIDTH, width=ICON_WIDTH, height=ICON_HEIGHT, relief="groove", bg = "blue violet", fg = "orchid1");
Temperature_icon.grid(row=TEMP_ROW, column=ICON_COLUMN, padx = GRID_PADX, pady = GRID_PADY);

Temperature = Button(root, text="Temperature", padx = BUTTON_PADX, pady = BUTTON_PADY, state=DISABLED, relief="groove", borderwidth=BORDER_WIDTH, font=("Times", "16", "bold"), width=4, height=1, fg = "orchid1");
